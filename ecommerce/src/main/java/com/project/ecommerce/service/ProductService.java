...
public class ProductService {
 ...
 private CategoryDAO categoryDAO;
	...
	public Product createProduct(Product product,int catid) throws ProductAlreadyExistsException 
	{
		if (productDAO.findBynameIgnoreCase(product.getName()).isPresent()) {
			throw new ProductAlreadyExistsException();
		  }
		    Category cat=this.categoryDAO.findById(catid).orElseThrow(()->new CategoryAlreadyExistsException("This Category id not found Catgory"));
