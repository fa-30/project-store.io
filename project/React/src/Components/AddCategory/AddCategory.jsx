...
export default function AddCategory() {
  ...
  async function addCategory(body) {
    ...
    axios.post(`http://localhost:8090/addCat`, body)
      .then(function (x) {
        setStillLoading(true);
        setTimeout(function () {
  ...
  return <>
    <div className="container mt-4 w-50">
      ...
      <form onSubmit={categoryForm.handleSubmit}>
        ...
        <div className="mb-2">
          <label htmlFor="imageName" className="form-label">Category image:</label>
          <input type="text" className="form-control" id="imageName" value={categoryForm.values.imageName} onChange={categoryForm.handleChange} onBlur={categoryForm.handleBlur} />
        </div>
        <div className=''>
