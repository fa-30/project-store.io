...
export default function AddProduct() {
    ...
    const validateSchema = yup.object({
        ...
        "longlongDescription": yup.string().required("longDescription is required"),
        ...
        <div className="container mt-4 w-50">
            ...
            <form onSubmit={registerForm.handleSubmit}>
                <div className="mb-2">
                    ...
                    <input type="text" className="form-control" id="name" value={registerForm.values.title} onChange={registerForm.handleChange} onBlur={registerForm.handleBlur} />
                ...
                <div className="mb-2">
                    <label htmlFor="longDescription" className="form-label">longDescription</label>
                    <textarea className="form-control" id="longDescription" value={registerForm.values.longDescription} onChange={registerForm.handleChange} onBlur={registerForm.handleBlur} rows="3"></textarea>
                    {registerForm.errors.longDescription && registerForm.touched.longDescription ? <div className='alert alert-danger mt-2'>{registerForm.errors.longDescription}</div> : null}
                </div>
                ...
                <div className="mb-2">
                    <label htmlFor="imageName" className="form-label">Image Cover Link</label>
                    <input type="text" className="form-control" id="imageName" value={registerForm.values.imageName} onChange={registerForm.handleChange} onBlur={registerForm.handleBlur} />
                    {registerForm.errors.imageName && registerForm.touched.imageName ? <div className='alert alert-danger mt-2'>{registerForm.errors.imageName}</div> : null}
